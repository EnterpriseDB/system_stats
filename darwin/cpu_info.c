...
void ReadCPUInformation(Tuplestorestate *tupstore, TupleDesc tupdesc)
{
    ...
    values[Anum_l1dcache_size] = Int32GetDatum((int)l1d_cache);
    values[Anum_l1icache_size] = Int32GetDatum((int)l1i_cache);
    values[Anum_l2cache_size] = Int32GetDatum((int)l2_cache);
    values[Anum_l3cache_size] = Int32GetDatum((int)l3_cache);
